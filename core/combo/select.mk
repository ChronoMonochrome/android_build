...
$(combo_var_prefix)RELEASE_CFLAGS := -O2 -Wstrict-aliasing=2 -Werror=strict-aliasing
$(combo_var_prefix)GLOBAL_CPPFLAGS :=
$(combo_var_prefix)GLOBAL_LDFLAGS := -Wl,-O2 -Wl,--as-needed -Wl,--relax -Wl,--sort-common -Wl,--gc-sections
