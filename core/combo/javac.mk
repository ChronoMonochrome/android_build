...
ifeq ($(BUILD_OS), windows)
    ...
    COMMON_JAVAC := javac -J-Xmx512M -target 1.7 -source 1.7 -Xmaxerrs 9999999
endif
...
ifeq ($(CUSTOM_JAVA_COMPILER), openjdk)
    ...
    COMMON_JAVAC := prebuilt/common/openjdk/bin/javac -target 1.8 \
        -source 1.8 -Xmaxerrs 9999999
